...
namespace ApiClientes.Service
{
    public class EnderecoService
    {
        ...
        public void DeletarEndereco(int idCliente)
        {
            ...
            if (!enderecos.Any())
            {
               throw new BadRequestException("Não encontrado nenhum endereço para esse cliente!");
            }
        ...
        public EnderecoDTO AtualizarEndereco(int idCliente, CriarEnderecoDTO dto)
        {
            EnderecoValidation.ValidarCriarEndereco(dto);
            ...
            if (enderecoAtualizado == null)
                throw new BadRequestException("Endereço não encontrado para o cliente.");
